    ...
    try:
        ...
        if res:
            ...
            if lh_count is not None:
                print(f"카운트: {int(lh_count)} 제품: {lh_code} 지그: {lh_zig}")
            else:
    ...
    try:
        ...
        if res:
            ...
            if rh_count is not None:
                print(f"카운트: {int(rh_count)} 제품: {rh_code} 지그: {rh_zig}")
            else:
...
def print_lh(lh_data):
    try:
        ...
        ^XZ
        """
        print(f"출력토크1: {lh_torq1_str} 출력토크2: {lh_torq2_str}")
...
def print_rh(rh_data):
    ...
    try:
        ...
        print(f"출력토크1: {rh_torq1_str} 출력토크2: {rh_torq2_str}")
